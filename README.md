# DCC Data Feed
DCC Data Feed (WDF) is a REST API and a WebSocket proxy for the DCC platform.
...
#Example:
http://localhost:6990/datafeed/ticker/DCC/BTC
http://localhost:6990/datafeed/ticker/DCC/8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS
```
Response:
```
    {
...
#Example:
http://localhost:6990/datafeed/trades/DCC/BTC/3
http://localhost:6990/datafeed/trades/DCC/BTC/1495296000000/1495296280000
```
Response:
```
[
...
#Example:
http://localhost:6990/datafeed/trades/DCC/BTC/3PCfUovRHpCoGL54UakGBTSDEXTbmYMU3ib/2
```
Response:
```
[
...
#Example:
http://localhost:6990/datafeed/ticker/DCC/BTC/30/5
http://localhost:6990/datafeed/candles/DCC/BTC/1440/1495238400000/1496102400000
```
Response:
```
[
...
#Example:
{"op":"subscribe trades/DCC/8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS"}
```
Message on new trade:
```
{
  "op" : "trades/DCC/8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS",
  "msg" : {
